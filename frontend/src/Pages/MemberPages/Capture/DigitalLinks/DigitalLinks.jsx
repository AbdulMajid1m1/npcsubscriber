        ...
        <table className="min-w-full mb-4">
          ...
          <tbody>
            <tr className='w-full text-center'>
              <td className="py-2 px-4 border-b text-sm">Luxurious green cardamom1</td>
              <td className="py-2 px-4 border-b text-sm">Nartec</td>
              <td className="py-2 px-4 border-b text-sm">
                <span className="bg-green-700 text-white rounded-full px-3 py-1">6281100042921</span>
              </td>
              <td className="py-2 px-4 border-b text-sm">CreativeM</td>
      ...
      <div className="pt-0 min-h-screen">
        <div className="bg-white p-3 shadow-md border-t-[20px] border-primary2 rounded-md">
          <div style={{ marginLeft: '-11px', marginRight: '-11px' }}>
            <DataTable
              data={data}
              title={activeTab === 'Certification' ? `${activeTab} - ${activeSubTab}` : activeTab}
