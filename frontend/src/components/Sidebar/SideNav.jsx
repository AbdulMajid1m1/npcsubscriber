...
import identify from "../../Images/sidebar/identify.png";
import capture from "../../Images/sidebar/capture.png";
import GTINmanagement from "../../Images/sidebar/GTINmanagement.png";
import GLNmanagement from "../../Images/sidebar/GLNmanagement.png";
import digitalLink from "../../Images/sidebar/digitalLink.png";
import MySharedData from "../../Images/sidebar/MySharedData.png";
import verifiedbyGS1 from "../../Images/sidebar/verifiedbyGS1.png";
import MyNPCservices from "../../Images/sidebar/MyNPCservices.png";
import governance from "../../Images/sidebar/governance.png";
import approvedrequest from "../../Images/sidebar/approvedrequest.png";
    ...
    <>
      <div className="bg-[#D0F2F3] p-0">
        <div className="body-content">
          <div className="relative lg:block navbar-menu">
            <nav
              className={`fixed top-0 transition-all bg-[#D0F2F3] lg:mt-0 mt-12 bottom-0 flex flex-col shadow bg-primary-sidebar overflow-hidden z-50 ${isOpen ? "w-[300px]" : "w-0"
                } left-0`}
              id="sidenav"
            >
              <div className="flex justify-center items-center w-full px-4 pt-3 pb-3 border-b border-gray-300">
                    ...
                    {brandOwnerIdentify && (
                      <div className="transition border-gray-500 dropdown-section nested-menu pl-3 ml-4">
                        <ul className="text-sm flex flex-col gap-3">
                          ...
                          <li>
                            <Link
                              to={"/member/SubmittedRequest"}
                              className="flex items-center py-2 text-gray-700 rounded hover:bg-gray-100 pl-3 pr-4 justify-start"
                            >
                              <div className="flex justify-center items-center gap-3 flex-row">
                                <img
                                  src={submittedrequest}
                                  alt="logo"
                                  className="w-7 h-7 object-cover"
                                />
                                <span className="text-base font-sans font-medium truncate">
        ...
        <div
          className={`mx-auto transition-all content-wrapper ${isOpen ? "lg:ml-[300px]" : "lg:ml-0"
            }`}
          id="dash"
        >
          <section className="sticky top-0 z-20 px-3 py-0 bg-[#1F0567] shadow text-gray-100 lg:px-5">
